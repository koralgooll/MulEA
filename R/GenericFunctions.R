...
#'     "FBgn0004407", "FBgn0010438", "FBgn0003742", "FBgn0029709",
#'     "FBgn0030341", "FBgn0037044", "FBgn0002887", "FBgn0028434",
#'     "FBgn0030170", "FBgn0263831")
#' dataFromExperimentPool <- unique(c(
#'     c("FBgn0033690", "FBgn0261618", "FBgn0004407", "FBgn0010438",
...
#'     method = "KS", gmt = modelDfFromFile, testData = dataFromExperiment)
#' rankedBasedTestSubramanian <- RankedBasedTest(
#'     method = "Subramanian",
#'     gmt = modelDfFromFile,
#'     testData = dataFromExperiment,
#'     scores = dataFromExperimentScores)
#' rankedBasedTestKsRes <- runTest(rankedBasedTestKs)
#' rankedBasedTestSubramanianRes <- runTest(rankedBasedTestSubramanian)
