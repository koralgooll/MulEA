...
#'   In the case of `run_test` was used with the model generated by the `ora` 
#'   function the returned `data.frame` contains the following columns:
#'   
...
#'   6. The adjusted *p*-value. The column named based on the 
#'      p_value_adjustment_method parameter of the `ora` function, *e.g.* 'eFDR'    
#'      
#'   In the case of `run_test` was used with the model generated by the `gsea` 
#'   function the returned `data.frame` contains the following columns:
#'   
#'   1. 'ontology_id': Identifiers of the ontology elements.
#'   2. 'ontology_name': Names of the ontology elements.
