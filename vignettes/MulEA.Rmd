...
```{r, results = 'asis', echo = TRUE} 
setBasedTestWithPoolAndAdjust <- ORA(gmt = modelDfFromFile, element_names = dataFromExperiment, pool = dataFromExperimentPool, adjustMethod = "PT", nthreads = 2)
...
#rankedBasedTestKs <- GSEA(method = "KS", gmt = modelDfFromFile, element_names = dataFromExperiment)
...
```{r, results = 'asis', echo=TRUE} 
rankedBasedTestSubramanian <- GSEA(method = "Subramanian", gmt = modelDfFromFile, element_names = dataFromExperiment, element_scores = dataFromExperimentScores)
