...
#rankedBasedTestKs <- GSEA(method = "KS", gmt = modelDfFromFile, testData = dataFromExperiment)
...
```{r, results = 'asis', echo=TRUE} 
rankedBasedTestSubramanian <- GSEA(method = "Subramanian", gmt = modelDfFromFile, testData = dataFromExperiment, element_scores = dataFromExperimentScores)
