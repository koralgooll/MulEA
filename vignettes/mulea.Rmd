---
title: "mulea"
author: "Cezary Turek, Márton Ölbe, Tamás Stirling, Gergely Fekete, Ervin Tasnádi, Leila Gul, Balázs Bohár, Balázs Papp, Wiktor Jurkowski & Eszter Ari"
date: "`r Sys.Date()`"
...
```{r 'lollipop_plot_ora', fig.height=4, fig.width=6}
...
```{r 'bar_plot_ora', fig.height=4, fig.width=6}
...
```{r 'network_plot_ora', fig.height=5, fig.width=7}
...
```{r 'heatmap_ora', fig.height=5, fig.width=7}
...
```{r 'lollipop_plot_gsea', fig.height=4, fig.width=6}
...
```{r 'bar_plot_gsea', fig.height=4, fig.width=6}
...
```{r 'network_plot_gsea', fig.height=5, fig.width=7}
...
```{r 'heatmap_gsea', fig.height=5, fig.width=10}
